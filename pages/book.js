...
const Book = () => {
  ...
  const confirmationMessage = (
    <div className="font-light text-lg text-white leading-relaxed tracking-wide flex flex-col gap-y-12 pt-24">
      ...
      <button
        ...
        onClick={() => router.replace("/book", undefined, { shallow: true })}> Submit Another Booking </button>
    </div>
  )
