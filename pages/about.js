    ...
    <AgeVerification>
      <div className="bg-[#EBEBEB]">
        <Head>
          ...
          <meta
            name="description"
            content="Learn about the story behind The Wonky Labrador, Sheffield’s favorite spot for craft beer lovers. Our mission is to create a welcoming community hub with a passion for quality beers and exceptional customer service."
          />
          <meta
            name="keywords"
            content="The Wonky Labrador story, Sheffield craft beer, community bar, quality beer, customer service, local bar history, Sheffield bar story, craft beer passion, bar founders, bar vision, bar mission, Sheffield brewery scene"
          />
          ...
          <section className="container mx-auto flex flex-col lg:flex-row justify-between sm:mt-2 mt-10 px-4 md:pb-24 pb-14 gap-x-20">
            ...
            <div className="lg:w-6/12 w-full h-full relative flex flex-col  my-auto order-1 lg:order-2">
              ...
              <p className="text-dark lg:text-xl text-lg mt-14 font-lato font-light tracking-wide lg:leading-relaxed leading-loose">
                ...
                Lincolnshire coastal boy. Mac has fallen in love with Sheffield
                & the Peak District and as a craft beer fanatic with 20 years
                experience in hospitality, opening a bar here was pretty much
                inevitable. His experiences of travelling through Europe and his
                stay in New Zealand has driven the service and style found in
                The Wonky Labrador
              </p>
              <p className="text-dark lg:text-xl text-lg mt-14 font-lato font-light tracking-wide lg:leading-relaxed leading-loose">
                We welcome boardgamers, beer aficionados, weekend
                cocktail-drinkers, and pre-dinner wine-lovers, as well as
            ...
            <div className="container mx-auto flex flex-col lg:flex-row justify-between sm:mt-2 mt-10 px-4 md:py-24 py-14 gap-x-20">
              <div className="lg:w-6/12 w-full h-full relative flex flex-col  my-auto ">
                <p className="text-white lg:text-xl text-lg  font-lato font-light tracking-wide lg:leading-relaxed leading-loose">
                  The opportunity to take over The Wonky Labrador has also
                  tapped into Mac’s love of community, and you’ll find this a
                  welcoming place for all walks of life, including our four
                  legged friends! We’re accessible and LGBTQ+ friendly,
                  breast-feeding supporters - and we’ll always listen to your
                  ideas for being a welcoming space.
                </p>
                <>
