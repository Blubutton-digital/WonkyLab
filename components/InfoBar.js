...
const InfoBar = () => {
  return (
    <div className="max-w-4xl sm:h-52  h-full p-0 bg-white mx-auto -translate-y-1/2 rounded-md flex flex-col sm:flex-row space-between drop-shadow-md sm:space-y-0 space-y-0 items-center relative">
